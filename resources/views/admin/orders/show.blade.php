                    ...
                    <tr>
                        <td colspan="4">
                            <form action="{{ route('admin.orders.ship',[$order->id]) }}" method="post"
                                ...
                                {{--别忘了csrf--}}
                                {{ csrf_field() }}
                                <div class="form-group {{ $errors->has('express_company') ? 'has-errors' : '' }}">
                                    <label for="express_company" class="control-label">物流公司</label>
                                    <input type="text" name="express_company" id="express_company" value=""
                                ...
                                <div class="form-group" {{ $errors->has('express_no') ? 'has-errors' : '' }}>
                                    <label for="express_no" class="control_label">物流单号</label>
                                    <input type="text" name="express_no" id="express_no" value="" class="form-control"
                                           placeholder="输入物流单号">
            ...
            swal({
                ...
                preConfirm: function (inputValue) {
                    ...
                    return $.ajax({
                        ...
                        contentType: 'application/json', //请求数据格式为json
                    });
                },
